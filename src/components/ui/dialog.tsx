...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Gleiche Abdunkelung wie der Mobile-Nav-Drawer (siehe layout/sidebar.tsx).
...
/**
 * Dialog-Breiten. Regel:
 *   sm → Bestätigung oder 1–2 Felder
 *   md → Standardformular (Default)
 *   lg → Stammdaten-Formular mit Grid
 *   xl → Editor / große Tabelle
 */
...
/**
 * Scrollender Formular-Bereich zwischen Header und Footer. Nutzen, wenn der
 * Inhalt hoch werden kann — Header und Footer (und damit „Speichern") bleiben
 * dann immer sichtbar.
 */
